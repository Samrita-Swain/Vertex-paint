...
const PremiumGlossEnamel = () => {
  const allProducts = [
 {
    ...
    {
      name: "PU Aluminum Paint",
      image: "/images/1.png",
      href: "/MetalPaints/PU_AluminumPaint",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
      "Advanced PUD Formula",
    ...
    {
      name: "PU Metallic Golden Paint",
      image: "/images/1.png",
      href: "/MetalPaints/PU_MetallicGoldenPaint",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
      "Advanced PUD Formula",
...
export default PremiumGlossEnamel;
