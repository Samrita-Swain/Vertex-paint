      ...
      <div className="second-banner p-12 flex justify-center items-center">
        <div className="container">
          <div className="content flex justify-center items-center flex-col">
            ...
            <p className="text-gray-600 text-lg font-normal mb-[35px] text-center">Here's why Metal Guard is perfect for your home.</p>
          </div>
...
export default SilkShine_SuperGloss;
