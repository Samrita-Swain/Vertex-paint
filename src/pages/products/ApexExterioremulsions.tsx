    ...
    <div>
      ...
      >
        ...
        <div className="relative content text-white text-center">
          <h1 className="text-[50px] font-bold">Apex Exterior Emulsions</h1>
        </div>
      </div>
...
export default ApexExterioremulsions;
