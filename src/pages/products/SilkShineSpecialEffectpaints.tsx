...
const SilkShineSpecialEffectpaints = () => {
    const allProducts = [
  {
    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium mb-7">Silk Shine Special Effect Paints</h1>
        </div>
...
export default SilkShineSpecialEffectpaints;
