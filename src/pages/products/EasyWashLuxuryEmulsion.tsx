    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium mb-7">Easy Wash Luxury Emulsion</h1>
        </div>

        {/* Centered Bouncing Image */}
        <div className="bounce-container flex justify-center items-center mt-6">
          <img
            src="/images/easy-wash-luxury-eml.png"
            alt="Bouncing"
...
export default EasyWashLuxuryEmulsion;
