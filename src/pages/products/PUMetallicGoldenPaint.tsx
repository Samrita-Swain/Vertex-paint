...
const PUMetallicGoldenPaint = () => {
  const allProducts = [
 {
      name: "Silver Ash, Emerland Green",
      image: "/images/1.png",
      href: "/MetalPaints/Silver_Ash_Emerland_Green",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
    ...
    {
      name: "Metal Clear Gloss",
      image: "/images/1.png",
      href: "/MetalPaints/MetalClearGloss",
      animation: true,
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
    ...
    {
      name: "Metal Clear Matt",
      image: "/images/1.png",
      href: "/MetalPaints/MetalClearMatt",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
      "Advanced PUD Formula",
    ...
    {
      name: "Premium Gloss Enamel",
      image: "/images/1.png",
      href: "/MetalPaints/PremiumGlossEnamel",
      animation: true,
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
    ...
    {
      name: "1K PU High Performance Enamel ",
      image: "/images/1.png",
      href: "/MetalPaints/1K_PU_HighPerformanceEnamel",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
      "Advanced PUD Formula",
    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium mb-7">PU Metallic Golden Paint</h1>
        </div>
      ...
      <div className="second-banner p-12 flex justify-center items-center">
        <div className="container">
          <div className="content flex justify-center items-center flex-col">
            ...
            <p className="text-gray-600 text-lg font-normal mb-[35px] text-center">Here's why Cool Roof is perfect for your home.</p>
          </div>
...
export default PUMetallicGoldenPaint;
