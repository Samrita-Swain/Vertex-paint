...
import { exteriorColor3 } from "../../data/content";
    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium">Soft & Relaxing</h1>
        </div>
      </div>
      ...
      <div className="second-banner p-12 flex justify-center items-center">
              <div className="container">
                <div className="content flex justify-center items-center flex-col">
                  <h2 className="gradient-text text-4xl font-semibold mb-2 text-center">Soft & Relaxing</h2>
           ...
           data-aos-duration="1500">
                    {exteriorColor3.map((color3, index) => {
