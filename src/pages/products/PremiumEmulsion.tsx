    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium mb-7">Premium Emulsion</h1>
        </div>
      ...
      <div className="second-banner p-12 flex justify-center items-center">
        <div className="container">
          <div className="content flex justify-center items-center flex-col">
            ...
            <p className="text-gray-600 text-lg font-normal mb-[35px] text-center">Here's why Acme Water Thinnable Cement Primer is perfect for your home.</p>
          </div>
...
export default PremiumEmulsion;
