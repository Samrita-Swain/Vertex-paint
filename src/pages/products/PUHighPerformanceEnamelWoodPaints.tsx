...
const PUHighPerformanceEnamelWoodPaints = () => {
  const allProducts = [
  {
      name: "WOOD GUARD",
      image: "/images/1.png",
      href: "/WoodPaints/WoodGuard",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
    ...
    {
      name: "TRUE WOOD - 1k PU Clear",
      image: "/images/1.png",
      href: "/WoodPaints/TrueWood_1k_PU_Clear",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
      "Advanced PUD Formula",
    ...
    },
    {
      ...
      image: "/images/1.png",
      href: "/WoodPaints/PremiumGlossEnamel",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
      "Advanced PUD Formula",
    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium mb-7">1K PU High Performance Enamel</h1>
        </div>
...
from ugly black spots.</p>
      ...
      <div className="exterior-Ultima-band p-12 bg-[#fff] flex flex-col items-center">
        ...
        <div className="ultimaproducts grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-[2rem]">
...
export default PUHighPerformanceEnamelWoodPaints;
