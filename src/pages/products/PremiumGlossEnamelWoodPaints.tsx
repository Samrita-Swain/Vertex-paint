...
const PremiumGlossEnamelWoodPaints = () => {
  const allProducts = [
 {
      name: "1K PU High Performance Enamel ",
      image: "/images/1.png",
      href: "/WoodPaints/1K_PU_HighPerformanceEnamel",
      features: [
      "WALLS of S.T.E.E.L",
      "15 years warranty*",
    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center">
          <h1 className="text-5xl font-medium mb-7">Premium Gloss Enamel</h1>
        </div>
...
export default PremiumGlossEnamelWoodPaints;
