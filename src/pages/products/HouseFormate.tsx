  ...
  return (
    <div className="flex flex-col justify-center items-center p-12">
      <div className="container flex flex-col justify-center items-center">
        ...
        <p className="mb-[35px] text-gray-600 text-md font-normal text-center">Tap the ‘House Format's button to choose a house
      ...
      hover:shadow-2xl relative overflow-hidden border-t border-l border-r border-[#efefef] border-opacity-100 hover:border-red-500" data-aos="zoom-in"
          ...
          >
            ...
            <h6 className="text-[17px] font-semibold text-black text-center">
              Crafted Cube
            </h6>
          </div>
