...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">ULTRA-WRP</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Acme Water Thinnable
              Cement Primer</h1>
              <a href="">
                View
              </a>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Acme Exterior Emulsion</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">BD Seal</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Cool Roof</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Easy Wash Luxury Emulsion</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Exterior Base coat</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Metal Guard Red Oxide Primer</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Premium Emulsion</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Select Mat Finish Emulsion</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Silk Shine Luxury Emulsion</h1>
              <a href="">
                View
              </a>
            </div>
...
>
            ...
            <div className="product-content flex flex-col items-center">
              <h1 className="mb-3 text-[19px] text-center">Titanium One</h1>
              <a href="">
                View
              </a>
            </div>
